...
{
    public class CreateCapitalItemCommandValidator : AbstractValidator<CreateCapitalItemCommand>
    {
        private readonly IApplicationDbContext _context;
        public CreateCapitalItemCommandValidator(IServiceScopeFactory scopeFactory)
        {
        ...
        public async Task<bool> HasValidNameDateCombo(CapitalItemRequestDto item, CancellationToken cancellationToken)
        {
