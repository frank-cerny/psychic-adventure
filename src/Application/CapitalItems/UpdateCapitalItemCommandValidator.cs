...
{
    public class UpdateCapitalItemCommandValidator : AbstractValidator<UpdateCapitalItemCommand>
    {
        // TODO
        private readonly IApplicationDbContext _context;
        public UpdateCapitalItemCommandValidator(IServiceScopeFactory scopeFactory)
        {
        ...
        // public async Task<bool> HasValidNameDateCombo(UpdateCapitalItemCommand request, CancellationToken cancellationToken)
        // {
        //     // We incorporate this check here due to the nature of async fluent assertions
        //     DateTime temp = new DateTime();
        //     if (!DateTime.TryParse(request.CapitalItemId.DatePurchased, out temp))
        //     {
        //         return false;
        //     }
        ...
        //     return nonCapitalItems.SingleOrDefault(ei => ei.Name.Equals(request.CapitalItemId.Name) && ei.DatePurchased.ToShortDateString().Equals(shortRequestDatetime) && request.CapitalItemId != ei.Id) == null;
        // }

        public bool HasAllRequiredValues(CapitalItemRequestDto item)
        {
