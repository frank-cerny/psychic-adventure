...
{
    public class CreateNonCapitalItemCommandValidator : AbstractValidator<CreateNonCapitalItemCommand>
    {
        private readonly IApplicationDbContext _context;
        public CreateNonCapitalItemCommandValidator(IServiceScopeFactory scopeFactory)
        {
